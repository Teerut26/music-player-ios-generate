...
interface Props {
    onRef: (area: React.RefObject<HTMLDivElement>) => void;
    Data: Result;
}

const Player: React.FC<Props> = ({ onRef, Data }) => {
    ...
    return (
        <div
            ref={area}
            className="w-[585px] h-[1007px] border-2 flex flex-col gap-5 items-center p-10 rounded-[3rem] bg-[#F6F6F6]"
        >
            <div>
                <img
            ...
            <div className="flex flex-col w-full">
                ...
                <div className="flex justify-between px-[5rem] items-center py-[1.5rem] mb-2">
                    ...
                    <svg
                        ...
                        xmlns="http://www.w3.org/2000/svg"
                    >
                        <rect width="37" height="129" rx="7" fill="#000000" />
                        <rect
                            x="57"
                            width="37"
                            height="129"
